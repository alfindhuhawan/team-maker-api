...
// getAllPlayerListHandler ...
func (r *Controller) getAllPlayerListHandler(inputPort getallplayerlist.Inport) gin.HandlerFunc {

	type request struct {
	}

	type response struct {
		Items []*entity.Player `json:"items"`
	}
	...
	return func(c *gin.Context) {
		...
		var req getallplayerlist.InportRequest
